...
{
    public partial class F_Emp : F_Master_List
    {
        public F_Emp()
        {
            InitializeComponent();
        ...
        public override void Get_Data(string status_mess)
        {
            ...
            try
            {
                ...
                TF_Pers_Emploee = cmdEmp.Get_All().FirstOrDefault();
                if (TF_Pers_Emploee != null)
                    Fill_Graid();
        ...
        public override void Insert_Data()
        {
            ...
            catch (Exception ex)
            {
                ...
                cmdEmp.Detached_Data(TF_Pers_Emploee);
            }
        ...
        public override void Update_Data()
        {
            try
            {
                if (Is_Double_Click)
                {
                    if (Validate_Data() && gv.RowCount > 0 && TF_Pers_Emploee != null)
                    {
        ...
        {
            txt_id.Text = TF_Pers_Emploee.Emp_id.ToString();
            txt_name.Text = TF_Pers_Emploee.Emp_name;

        }
        public void Fill_Entitey()
        {
            //  TF_Pers_Emploee.med_cat_id = Convert.ToInt32(txt_id.Text);

            TF_Pers_Emploee.Emp_name = txt_name.Text.Trim();
        ...
        {
            Object x = new object();
            x = (from Emp_s in cmdEmp.Get_All()
                 select new
                 {
                     id = Emp_s.Emp_id,
                     name = Emp_s.Emp_name,
        ...
        private void Set_Auto_Id()
        {
            ...
            txt_id.Text = Max_Id == null ? "1" : (Max_Id.Emp_id + 1).ToString();
